...
from moneybelieve.views import *

class TestUrls(TestCase): # moneybelieve:index URL にアクセスした時のステータス 200 を確認するテスト
  def test_index_url_reverse(self):
    ...
    """
    url = reverse('moneybelieve:index') # moneybelieve:index の URL を逆引き
